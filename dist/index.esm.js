import React, { forwardRef, createElement, useState, useMemo, useRef, useEffect, useCallback } from 'react';
...
const VideoOff = createLucideIcon("video-off", __iconNode$2);
...
const LandingPage = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: index
  }, line, /*#__PURE__*/React.createElement("br", null)))), /*#__PURE__*/React.createElement("p", {
    className: styles.subheading
  }, text.subheading)), /*#__PURE__*/React.createElement("div", {
  ...
  }), text.creatingButton) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(iconComponents.video, {
    className: "w-5 h-5"
  }), text.createButton)), /*#__PURE__*/React.createElement("div", {
    className: styles.dividerContainer
  }, /*#__PURE__*/React.createElement("div", {
    className: styles.dividerLine
  }, /*#__PURE__*/React.createElement("div", {
    className: styles.dividerLineInner
  })), /*#__PURE__*/React.createElement("div", {
    className: styles.dividerTextContainer
  ...
  }, text.joinButton)), error && /*#__PURE__*/React.createElement("div", {
...
const PrejoinPage = ({
  ...
  const ToggleButton = ({
    ...
    const buttonClass = useMemo(() => `${style.toggleButtonBase} ${enabled ? "bg-blue-600 text-white" : "bg-gray-500 text-gray-200"}`, [enabled]);
    const handleClick = async () => {
      if (isConnecting) return;
      try {
        const devices = await navigator.mediaDevices.enumerateDevices();
        const relevantDevices = devices.filter(device => mediaType === "camera" ? device.kind === "videoinput" : mediaType === "microphone" ? device.kind === "audioinput" : false);
        if (relevantDevices.length === 0) {
          console.log(`No ${mediaType === "camera" ? "camera" : "microphone"} detected. Cannot toggle.`);
          return;
        }
    ...
    }, enabled ? /*#__PURE__*/React.createElement(IconOn, {
      className: "w-6 h-6"
    }) : /*#__PURE__*/React.createElement(IconOff, {
      className: "w-6 h-6"
    }));
  };
  const DeviceSelect = ({
    ...
    value: ""
  }, "Select ", label), options.map(device => /*#__PURE__*/React.createElement("option", {
    key: device.deviceId,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, text.heading), /*#__PURE__*/React.createElement("p", {
    className: style.subheading
  }, text.subheading), /*#__PURE__*/React.createElement("label", {
    htmlFor: "userName",
    className: style.label
  }, text.displayNameLabel), /*#__PURE__*/React.createElement("input", {
    id: "userName",
    type: "text",
    disabled: isConnecting,
    value: userName,
    ...
    autoComplete: "off"
  }), isHost && meetingLink && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("label", {
    className: style.label
  }, text.shareLinkLabel), /*#__PURE__*/React.createElement("div", {
  ...
  }, linkCopied ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(iconComponents.check, {
    className: "w-4 h-4 text-green-600"
  }), /*#__PURE__*/React.createElement("span", {
    className: "text-green-600"
  }, text.copiedText)) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(iconComponents.copy, {
    className: "w-4 h-4"
  }), text.copyButton))), /*#__PURE__*/React.createElement("p", {
    className: style.shareNote
  }, text.shareLinkNote)), /*#__PURE__*/React.createElement("button", {
    onClick: joinMeeting,
    disabled: !userName.trim() || isConnecting,
    className: style.joinButton,
    type: "button"
  }, isConnecting ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: style.spinner
  }), text.joiningButton) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(iconComponents.video, {
    className: "w-6 h-6"
  }), isHost ? text.joinButtonHost : text.joinButtonGuest)), connectionError && /*#__PURE__*/React.createElement("div", {
    className: style.errorBox
  }, connectionError || text.errorConnection))), /*#__PURE__*/React.createElement("div", {
    className: style.rightPanel
  }, /*#__PURE__*/React.createElement("div", {
    className: style.previewBox
  }, previewEnabled.video ? /*#__PURE__*/React.createElement("div", {
    ref: previewRef,
    className: style.cameraFeed
  }) : /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col items-center justify-center gap-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: style.avatar
  }, userName ? getInitials(userName) : "YN"), /*#__PURE__*/React.createElement("span", {
    className: style.cameraStatus
  }, text.cameraOffText))), /*#__PURE__*/React.createElement("div", {
    className: style.controlsCard
  }, /*#__PURE__*/React.createElement("div", {
    className: style.toggleButtons
  }, /*#__PURE__*/React.createElement(ToggleButton, {
    enabled: previewEnabled.video,
    onClick: () => setPreviewEnabled(prev => ({
      ...prev,
      video: !prev.video
    })),
...
const LeaveMeetingModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, isHost ? "Transfer Host & Leave Meeting" : "Leave Meeting"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-300 mb-6"
  }, isHost && hasOtherParticipants ? "As the host, you need to select a new host before leaving the meeting." : "Are you sure you want to leave the meeting?"), isHost && hasOtherParticipants && /*#__PURE__*/React.createElement("div", {
    className: "mb-6"
  }, /*#__PURE__*/React.createElement("label", {
    className: "block text-white text-sm font-medium mb-3"
  }, "Select New Host:"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, otherParticipants.map(participant => /*#__PURE__*/React.createElement("label", {
    key: participant.id,
  ...
  }, getInitials(participant.name))), /*#__PURE__*/React.createElement("span", {
    ...
    disabled: !canLeave,
    className: `px-4 py-2 rounded-lg transition duration-200 ${canLeave ? "bg-red-600 hover:bg-red-700 text-white" : "bg-gray-600 text-gray-400 cursor-not-allowed"}`
  }, isHost && hasOtherParticipants ? "Transfer & Leave" : "Leave Meeting"))));
};
...
const MeetingRoomPage = ({
  ...
  const hasScreenShare = screenShareState.isSharing || screenShareState.isReceiving;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Video Meeting"), /*#__PURE__*/React.createElement("button", {
    onClick: copyMeetingLink,
    className: "flex items-center gap-2 px-3 py-1 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition duration-200"
  }, linkCopied ? /*#__PURE__*/React.createElement(iconComponents.check, {
    className: "w-4 h-4"
  }) : /*#__PURE__*/React.createElement(iconComponents.copy, {
    className: "w-4 h-4"
  }), linkCopied ? "Copied!" : "Copy Link")), /*#__PURE__*/React.createElement("div", {
    className: "text-white text-sm pointer-events-none select-none",
    "aria-disabled": true
  }, participants.length, " participant", participants.length !== 1 ? "s" : "")), /*#__PURE__*/React.createElement("div", {
    className: "flex-1 flex h-screen overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex-1 p-4"
  }, hasScreenShare ? /*#__PURE__*/React.createElement("div", {
  ...
  }, screenShareParticipant ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ref: element => setSubscriberRef(screenShareParticipant.id, element),
    className: "w-full h-full relative"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm z-50"
  }, screenShareParticipant.name, " - Screen Share")) : screenShareState.isSharing ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ref: publisherElementRef,
    className: "w-full h-full relative"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm z-50"
  }, userName, " - Screen Share (You)")) : /*#__PURE__*/React.createElement("h1", null, "Screen Share")), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 overflow-x-auto",
    style: {
      height: "25%"
    }
  }, !screenShareState.isSharing && /*#__PURE__*/React.createElement("div", {
    ...
    ref: publisherElementRef,
    className: "w-full h-full relative"
  }), !meetingState.video && /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-sm font-semibold text-white"
  }, getInitials(userName)))), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-1 left-1 bg-black bg-opacity-50 text-white px-1 py-0.5 rounded text-xs"
  }, "You")), regularParticipants.map(participant => /*#__PURE__*/React.createElement("div", {
    key: participant.id,
    className: "bg-gray-800 rounded-lg relative overflow-hidden flex-shrink-0",
    style: {
      width: "200px",
    ...
    ref: element => setSubscriberRef(participant.id, element),
    className: "w-full h-full relative"
  }), !participant.video && /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 bg-gray-700 flex items-center justify-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-sm font-semibold text-white"
  }, getInitials(participant.name)))), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-1 left-1 bg-black bg-opacity-50 text-white px-1 py-0.5 rounded text-xs"
  }, participant.name))))) : /*#__PURE__*/React.createElement("div", {
    className: `grid ${participants.length === 1 ? "grid-cols-1" : participants.length <= 4 ? "grid-cols-2" : "grid-cols-3"} gap-4 h-full`
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute inset-0 bg-gray-700 flex items-center justify-center z-50"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm z-50"
  }, userName, " (You)"), !meetingState.audio && /*#__PURE__*/React.createElement("div", {
    className: "absolute top-2 right-2 bg-red-600 p-1 rounded-full z-50"
  }, /*#__PURE__*/React.createElement(iconComponents.micOff, {
    className: "w-4 h-4 text-white"
  }))), participants.filter(p => !p.isLocal).map(participant => /*#__PURE__*/React.createElement("div", {
    key: participant.id,
    className: "bg-gray-800 rounded-lg relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    ref: element => setSubscriberRef(participant.id, element),
    ...
    className: "absolute bottom-2 left-2 bg-black bg-opacity-50 text-white px-2 py-1 rounded text-sm z-50"
  }, participant.name), !participant.audio && /*#__PURE__*/React.createElement("div", {
    className: "absolute top-2 right-2 bg-red-600 p-1 rounded-full z-50"
  }, /*#__PURE__*/React.createElement(iconComponents.micOff, {
    className: "w-4 h-4 text-white"
  })))))), meetingState.chat && /*#__PURE__*/React.createElement("div", {
    className: "bg-gray-900 border-l border-gray-700 flex flex-col shadow-lg w-[360px]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3 border-b border-gray-700 bg-gray-800 flex justify-between"
  }, /*#__PURE__*/React.createElement("h3", {
    ...
    title: "Close Chat"
  }, /*#__PURE__*/React.createElement(iconComponents.x, {
    className: "w-5 h-5"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "flex-1 p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800"
  }, chatMessages.map(message => /*#__PURE__*/React.createElement("div", {
    key: message.id,
    className: "mb-4 group"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-400 mb-1 flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-medium text-gray-300"
  }, message.sender), /*#__PURE__*/React.createElement("span", null, "\u2022"), /*#__PURE__*/React.createElement("span", null, message.timestamp ? new Date(message.timestamp).toLocaleTimeString() : "Unknown time")), /*#__PURE__*/React.createElement("div", {
    className: "text-white text-sm bg-gray-700/50 rounded-lg p-2 break-words whitespace-pre-wrap transition-all group-hover:bg-gray-700/70"
  }, message.message, message.type === "screenshot" && message.screenshots && /*#__PURE__*/React.createElement("div", {
    className: "mt-2 space-y-2"
  }, message.screenshots.map((screenshot, index) => /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDCF8"), /*#__PURE__*/React.createElement("span", null, screenshot.filename)), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Screenshot shared at", " ", new Date(screenshot.timestamp).toLocaleTimeString()))))))), /*#__PURE__*/React.createElement("div", {
    ref: messagesEndRef
  })), /*#__PURE__*/React.createElement("div", {
    className: "p-2 border-t border-gray-700 bg-gray-800"
  }, chatAttachments.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "mb-2 p-2 bg-gray-700/50 rounded border-l-2 border-blue-500"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-300 mb-1"
  }, "Attachments:"), chatAttachments.map(attachment => /*#__PURE__*/React.createElement("div", {
    key: attachment.id,
    className: "bg-gray-600/50 rounded px-2 py-1 mb-2"
  }, attachment.type === 'screenshot' && /*#__PURE__*/React.createElement("div", {
    className: "mb-2"
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDCF8"), /*#__PURE__*/React.createElement("span", null, attachment.filename)), /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => {
      setChatAttachments(prev => prev.filter(a => a.id !== attachment.id));
      setChatInput(prev => prev.replace(`📸 Screenshot attached: ${attachment.filename}`, "").trim());
    },
  ...
  }, "Send"))), showScreenshotModal && selectedScreenshot && /*#__PURE__*/React.createElement("div", {
  ...
  }, selectedScreenshot.filename), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      const link = document.createElement("a");
    ...
    className: "flex-1 flex items-center justify-center bg-gray-900 rounded"
  }, /*#__PURE__*/React.createElement("img", {
    src: selectedScreenshot.url,
    alt: selectedScreenshot.filename,
    className: "max-w-full max-h-full object-contain"
  })))))), meetingState.participants && /*#__PURE__*/React.createElement("div", {
    className: "w-[20rem] bg-gray-900 border-l border-gray-700 flex flex-col shadow-lg"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-3 border-b border-gray-700 bg-gray-800 flex justify-between"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-white text-lg font-semibold tracking-tight"
  }, "Participants (", participants.length, ")"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center shadow-md"
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, participant.name, " ", participant.isLocal && "(You)")), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2"
  }, !participant.audio && /*#__PURE__*/React.createElement(iconComponents.micOff, {
    className: "w-5 h-5 text-red-400"
  }), !participant.video && /*#__PURE__*/React.createElement(iconComponents.videoOff, {
    className: "w-5 h-5 text-red-400"
  })))))), showReactionPicker && /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-20 left-1/2 transform -translate-x-1/2 bg-gray-800 border border-gray-600 rounded-lg p-3 z-50"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-4 gap-2"
  }, availableEmojis.map(reaction => /*#__PURE__*/React.createElement("button", {
    key: reaction.name,
  ...
  }, reaction.emoji))))), /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 pointer-events-none z-[9999]"
  }, reactions.map(reaction => /*#__PURE__*/React.createElement("div", {
    key: reaction.id,
    ...
    className: "bg-black bg-opacity-70 text-white px-3 py-2 rounded-lg flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-2xl"
  }, reaction.emoji), /*#__PURE__*/React.createElement("span", {
    className: "text-sm font-medium"
  }, reaction.sender))))), /*#__PURE__*/React.createElement("div", {
    ...
    className: `p-3 rounded-full ${!hasCamera ? "bg-gray-500 cursor-not-allowed opacity-50" : meetingState.video ? "bg-gray-700 hover:bg-gray-600" : "bg-red-600 hover:bg-red-700"} text-white transition duration-200`,
    disabled: !hasCamera
  }, meetingState.video ? /*#__PURE__*/React.createElement(iconComponents.video, {
    className: "w-6 h-6"
  }) : /*#__PURE__*/React.createElement(iconComponents.videoOff, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      if (!hasMicrophone) {
    ...
    className: `p-3 rounded-full ${!hasMicrophone ? "bg-gray-500 cursor-not-allowed opacity-50" : meetingState.audio ? "bg-gray-700 hover:bg-gray-600" : "bg-red-600 hover:bg-red-700"} text-white transition duration-200`,
    disabled: !hasMicrophone
  }, meetingState.audio ? /*#__PURE__*/React.createElement(iconComponents.mic, {
    className: "w-6 h-6"
  }) : /*#__PURE__*/React.createElement(iconComponents.micOff, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    ...
    title: "Share screen",
    className: `p-3 rounded-full ${meetingState.screenShare ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-700 hover:bg-gray-600"} text-white transition duration-200`
  }, /*#__PURE__*/React.createElement(iconComponents.screenShare, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: handleScreenshot,
    title: "Take screenshot",
    className: "p-3 rounded-full bg-gray-700 hover:bg-gray-600 text-white transition duration-200"
  }, /*#__PURE__*/React.createElement(iconComponents.screenShot, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: toggleChat,
    title: "Chat",
    className: `p-3 rounded-full ${meetingState.chat ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-700 hover:bg-gray-600"} text-white transition duration-200`
  }, /*#__PURE__*/React.createElement(iconComponents.chat, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    onClick: toggleParticipants,
    title: "Participants",
    className: `p-3 rounded-full ${meetingState.participants ? "bg-blue-600 hover:bg-blue-700" : "bg-gray-700 hover:bg-gray-600"} text-white transition duration-200`
  }, /*#__PURE__*/React.createElement(iconComponents.users, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    ...
    className: "p-3 rounded-full bg-gray-700 hover:bg-gray-600 text-white transition duration-200"
  }, /*#__PURE__*/React.createElement(iconComponents.reactions, {
    className: "w-6 h-6"
  })), /*#__PURE__*/React.createElement("button", {
    title: "Leave meeting",
  ...
  }, /*#__PURE__*/React.createElement(iconComponents.phoneOff, {
    className: "w-6 h-6"
  })))), showDeviceError && /*#__PURE__*/React.createElement("div", {
    className: "fixed top-4 right-4 bg-red-600 text-white px-4 py-2 rounded-lg shadow-lg z-50 animate-pulse"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement(iconComponents.alertCircle, {
    className: "w-5 h-5"
  }), /*#__PURE__*/React.createElement("span", null, showDeviceError))), /*#__PURE__*/React.createElement(LeaveMeetingModal, {
...
const VonageVideoMeeting = _ref => {
  var _devices$cameras, _devices$microphones;
  let {
  ...
  const iconComponents = _objectSpread2(_objectSpread2({}, defaultIcons), icons);
  ...
  const themeColors = _objectSpread2(_objectSpread2({}, defaultTheme), theme);

  // Load Vonage SDK on mount
  useEffect(() => {
    loadVonageSDK().then(sdk => {
      setOT(sdk);
      console.log("Vonage Video SDK loaded successfully");
    }).catch(error => {
      console.error("Failed to load Vonage Video SDK:", error);
      setConnectionError("Failed to load video SDK. Please refresh the page.");
    });
  }, []);
  ...
  const initializeDevices = useCallback(async () => {
    if (!OT) return;
    try {
      var _deviceInfo$cameras, _deviceInfo$microphon;
      const deviceInfo = await checkDeviceAvailability();
      if (!deviceInfo.hasCamera && !deviceInfo.hasMicrophone) {
        setConnectionError("No camera or microphone detected. Please connect at least one device.");
        return;
      }
      setDevices({
      ...
      setSelectedDevices({
        camera: ((_deviceInfo$cameras = deviceInfo.cameras) === null || _deviceInfo$cameras === void 0 || (_deviceInfo$cameras = _deviceInfo$cameras[0]) === null || _deviceInfo$cameras === void 0 ? void 0 : _deviceInfo$cameras.deviceId) || "",
        microphone: ((_deviceInfo$microphon = deviceInfo.microphones) === null || _deviceInfo$microphon === void 0 || (_deviceInfo$microphon = _deviceInfo$microphon[0]) === null || _deviceInfo$microphon === void 0 ? void 0 : _deviceInfo$microphon.deviceId) || ""
      });
  ...
  useEffect(() => {
    if (currentView === "prejoin" && previewRef.current && OT) {
      const initializePreview = async () => {
        ...
        const publisherOptions = {
          ...
          videoSource: selectedDevices.camera && deviceInfo.hasCamera ? selectedDevices.camera : undefined,
          audioSource: selectedDevices.microphone && deviceInfo.hasMicrophone ? selectedDevices.microphone : undefined
        };
        const publisher = OT.initPublisher(previewRef.current, publisherOptions, error => {
          if (error) {
            console.error("Error initializing publisher for preview:", error);
            setConnectionError("Failed to access available camera/microphone");
          }
        });
    ...
    return () => {
      ...
      // Don't destroy publisher when moving to meeting
      publisherRef.current && typeof publisherRef.current.destroy === "function") {
        publisherRef.current.destroy();
        publisherRef.current = null;
      }
    };
  }, [currentView, previewEnabled, selectedDevices, OT, checkDeviceAvailability]);
  ...
  const updateUrlForJoining = useCallback((sessionId, token, userName, isHost) => {
    const currentPath = window.location.pathname;
    const newUrl = "".concat(currentPath, "?token=").concat(encodeURIComponent(token), "&user=").concat(encodeURIComponent(userName), "&host=").concat(isHost);
  ...
  const joinMeeting = useCallback(async () => {
    ...
    try {
      ...
      const deviceInfo = await checkDeviceAvailability();
      if (!deviceInfo.hasCamera && !deviceInfo.hasMicrophone) {
        setConnectionError("Cannot join meeting: No camera or microphone detected. Please connect at least one device and try again.");
      ...
      console.log("Using Token:", ((_currentToken = currentToken) === null || _currentToken === void 0 ? void 0 : _currentToken.substring(0, 20)) + "...");
      ...
      session.on("streamCreated", event => {
        ...
        // Skip own stream
        if (session.connection && session.connection.connectionId === stream.connection.connectionId) {
        ...
        const isScreenShare = stream.name && stream.name.includes("(Screen)") || stream.videoType === "screen" || stream.connection && stream.connection.data && JSON.parse(stream.connection.data || "{}").isScreenShare;
        if (isScreenShare) {
          ...
          subscriberContainer.id = "screen-share-".concat(stream.streamId);
          const subscriber = session.subscribe(stream, subscriberContainer, {
            insertMode: "append",
            width: "100%",
            height: "100%",
            ...
            subscribersRef.current.set("screenshare-".concat(stream.streamId), subscriber);

            // Update screen share state
            setScreenShareState(prev => _objectSpread2(_objectSpread2({}, prev), {}, {
              isReceiving: true,
              sharedBy: stream.name ? stream.name.replace(" (Screen)", "") : "Remote User",
            ...
            setParticipants(prev => {
              ...
              return [...prev, {
                id: stream.streamId,
                name: stream.name ? stream.name.replace(" (Screen)", "") : "Remote User",
                isLocal: false,
                video: true,
          ...
          setTimeout(() => {
            ...
            try {
              console.log("Attempting to subscribe to regular stream:", stream.streamId);
              ...
              const subscriber = session.subscribe(stream, tempContainer, {
                insertMode: "append",
                width: "100%",
                height: "100%",
                subscribeToAudio: true,
                ...
                setParticipants(prev => {
                  const existingStreamIndex = prev.findIndex(p => p.id === stream.streamId);
                  if (existingStreamIndex !== -1) {
                    const updated = [...prev];
                    updated[existingStreamIndex] = _objectSpread2(_objectSpread2({}, updated[existingStreamIndex]), {}, {
                  ...
                  const existingConnectionIndex = prev.findIndex(p => !p.isLocal && p.id === stream.connection.connectionId);
                  if (existingConnectionIndex !== -1) {
                    const updated = [...prev];
                    updated[existingConnectionIndex] = _objectSpread2(_objectSpread2({}, updated[existingConnectionIndex]), {}, {
                      id: stream.streamId,
                      name: stream.name || updated[existingConnectionIndex].name,
                      video: stream.hasVideo,
                      audio: stream.hasAudio,
                      subscriber
                    });
                ...
                subscriber.on("videoEnabled", () => {
                  setParticipants(prev => prev.map(p => p.id === stream.streamId ? _objectSpread2(_objectSpread2({}, p), {}, {
                    video: true
                  }) : p));
                });
      ...
      session.on("streamDestroyed", event => {
        const stream = event.stream;
        const isScreenShare = stream.name && stream.name.includes("(Screen)") || stream.videoType === "screen";
        console.log("Stream destroyed:", stream.streamId, "isScreenShare:", isScreenShare);
        if (isScreenShare) {
          // Clean up screen share
          subscribersRef.current.delete("screenshare-".concat(stream.streamId));
          setScreenShareState({
            isSharing: false,
            isReceiving: false,
            sharedBy: null,
          ...
          subscribersRef.current.delete(stream.streamId);
          setParticipants(prev => prev.filter(p => p.id !== stream.streamId));
        }
      });
      session.on("connectionCreated", event => {
        const isLocal = event.connection.connectionId === session.connection.connectionId;
        ...
        setParticipants(prev => {
          const exists = prev.find(p => p.id === event.connection.connectionId);
          if (exists) return prev;
          return [...prev, {
      ...
      session.on("connectionDestroyed", event => {
        ...
        if (event.connection && event.connection.connectionId) {
          ...
          setParticipants(prev => prev.filter(p => {
            ...
            if (p.subscriber && p.subscriber.stream && p.subscriber.stream.connection) {
              const shouldRemove = p.subscriber.stream.connection.connectionId === connectionId;
              if (shouldRemove) {
      ...
      session.on("exception", event => {
        ...
        setConnectionError("Session error: ".concat(event.message || "Unknown error"));
      });
      session.on("signal:hostTransfer", event => {
        try {
          ...
          const isNewHost = session.connection && session.connection.connectionId === newHostId;
          ...
          setParticipants(prev => prev.map(p => {
            ...
            } else if ((_p$subscriber = p.subscriber) !== null && _p$subscriber !== void 0 && (_p$subscriber = _p$subscriber.stream) !== null && _p$subscriber !== void 0 && _p$subscriber.connection) {
          ...
          console.log("Host transferred from ".concat(previousHost, " to ").concat(newHostName));
        } catch (error) {
      ...
      setParticipants(prev => {
        ...
        const newParticipants = allConnections.filter(conn => conn && conn.connectionId && !ids.has(conn.connectionId)).map(conn => {
          let name = "Remote User";
          if (conn.data) {
            try {
      ...
      setMeetingState(prev => _objectSpread2(_objectSpread2({}, prev), {}, {
      ...
      const publisherOptions = {
        ...
        videoSource: selectedDevices.camera && deviceInfo.hasCamera && finalVideoState ? selectedDevices.camera : undefined,
        audioSource: selectedDevices.microphone && deviceInfo.hasMicrophone && finalAudioState ? selectedDevices.microphone : undefined,
        resolution: "640x480",
        frameRate: 15,
        style: {
          buttonDisplayMode: "off",
      ...
      const publisherPromise = new Promise((resolve, reject) => {
        const publisher = OT.initPublisher(publisherElementRef.current, publisherOptions, error => {
          var _publisher$element;
          if (error) {
          ...
          console.log("Publisher video element:", (_publisher$element = publisher.element) === null || _publisher$element === void 0 ? void 0 : _publisher$element.querySelector("video"));

          // Verify the publisher was actually added to the DOM
          if (publisherElementRef.current) {
            console.log("Publisher container after creation:", publisherElementRef.current.innerHTML);
            console.log("Publisher container children:", publisherElementRef.current.children);
          }
          ...
          publisher.on("videoEnabled", () => {
            ...
            setParticipants(prev => prev.map(p => p.isLocal ? _objectSpread2(_objectSpread2({}, p), {}, {
              video: true
            }) : p));
          });
      ...
      if (error.code === 4010 || error.name === "OT_SOCKET_CLOSE_TIMEOUT") {
        ...
        errorMessage += "Invalid session credentials. Please check your API key, session ID, and token.";
  ...
  }, [userName, sessionId, token, apiKey, isHost, generateToken, OT, checkDeviceAvailability, updateUrlForJoining]);
  useEffect(() => {
  ...
  const toggleVideo = async () => {
    ...
    if (publisherRef.current && typeof publisherRef.current.publishVideo === "function") {
  ...
  const toggleAudio = async () => {
    ...
    if (publisherRef.current && typeof publisherRef.current.publishAudio === "function") {
    ...
    try {
      if (screenShareState.isSharing) {
        if (publisherRef.current) {
          sessionRef.current.unpublish(publisherRef.current);
          publisherRef.current.destroy();
          const cameraPublisher = OT.initPublisher(publisherElementRef.current, {
            insertMode: "append",
            width: "100%",
            height: "100%",
            name: userName,
        ...
        try {
          ...
          const screenPublisher = OT.initPublisher(publisherElementRef.current, {
            insertMode: "append",
            width: "100%",
            height: "100%",
  ...
  const takeScreenshot = useCallback(async function () {
    let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    const {
      filename = "meeting-screenshot-".concat(new Date().toISOString().slice(0, 19).replace(/:/g, "-"), ".png"),
      quality = 0.9,
      format = "image/png",
      method = "auto"
    } = options;
    const html2canvasScreenshot = async () => {
      ...
      const videoContainer = document.querySelector(".meeting-room .video-container") || document.querySelector(".video-container") || document.querySelector("#video-container");
      if (!videoContainer) {
      ...
      return new Promise((resolve, reject) => {
        canvas.toBlob(blob => {
          ...
          if (screenShotWithChat) {
            const screenshotId = "screenshot_".concat(Date.now(), "_").concat(Math.random().toString(36).substr(2, 9));
            ...
            const placeholderText = "\uD83D\uDCF8 Screenshot attached: ".concat(filename);
    ...
    try {
      if (method === "screen-capture" || method === "auto") {
        try {
          ...
          console.warn("Screen capture failed, trying element capture:", error.message);
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        sessionRef.current.signal({
          ...
          data: JSON.stringify({
            newHostId,
            newHostName: (_participants$find = participants.find(p => p.id === newHostId)) === null || _participants$find === void 0 ? void 0 : _participants$find.name,
  ...
  const leaveMeeting = async function () {
    let newHostId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    setShowLeaveMeetingModal(false);
    try {
      if (isHost && newHostId && sessionRef.current) {
        var _newHostParticipant$s;
        const newHostParticipant = participants.find(p => p.id === newHostId);
        let newHostConnectionId = newHostId;
        if (newHostParticipant !== null && newHostParticipant !== void 0 && (_newHostParticipant$s = newHostParticipant.subscriber) !== null && _newHostParticipant$s !== void 0 && (_newHostParticipant$s = _newHostParticipant$s.stream) !== null && _newHostParticipant$s !== void 0 && _newHostParticipant$s.connection) {
        ...
        await new Promise((resolve, reject) => {
          sessionRef.current.signal({
            ...
            data: JSON.stringify({
              ...
              newHostName: (newHostParticipant === null || newHostParticipant === void 0 ? void 0 : newHostParticipant.name) || "Unknown",
              previousHost: userName
            })
          }, error => {
            if (error) {
      ...
      subscribersRef.current.clear();
      if (publisherRef.current && typeof publisherRef.current.destroy === "function") {
        publisherRef.current.destroy();
        publisherRef.current = null;
      }
  ...
  const sendChatMessage = useCallback(() => {
    ...
    if (hasScreenshots) {
      ...
      messageData.message = chatInput.replace(/📸 Screenshot attached: .*$/gm, "").trim();
      if (!messageData.message) {
        messageData.message = "Shared ".concat(chatAttachments.length, " screenshot").concat(chatAttachments.length > 1 ? "s" : "");
      }
    }
    try {
      setChatMessages(prev => [...prev, messageData]);
      if (sessionRef.current) {
        const signalData = _objectSpread2(_objectSpread2({}, messageData), {}, {
  ...
  }, [chatInput, chatAttachments, userName, sessionRef, setChatMessages, setChatInput, setChatAttachments]);
  useEffect(() => {
    if (!sessionRef.current) return;
    const handleChatSignal = event => {
      try {
        const msg = JSON.parse(event.data);
        setChatMessages(prev => [...prev, _objectSpread2(_objectSpread2({}, msg), {}, {
    ...
    return () => {
      ...
      (_sessionRef$current = sessionRef.current) === null || _sessionRef$current === void 0 || _sessionRef$current.off("signal:chat", handleChatSignal);
    };
  }, [sessionRef.current]);
  ...
  if (currentView === "prejoin" || meetingLink === window.location.pathname) {
    return /*#__PURE__*/React.createElement(PrejoinPage, {
      iconComponents: iconComponents,
      userName: userName,
  ...
  // Meeting Room
  return /*#__PURE__*/React.createElement(MeetingRoomPage, {
    copyMeetingLink: copyMeetingLink,
    linkCopied: linkCopied,
    iconComponents: iconComponents,
    participants: participants,
    ...
    hasCamera: ((_devices$cameras = devices.cameras) === null || _devices$cameras === void 0 ? void 0 : _devices$cameras.length) > 0 || false,
    hasMicrophone: ((_devices$microphones = devices.microphones) === null || _devices$microphones === void 0 ? void 0 : _devices$microphones.length) > 0 || false,
...
class VonageVideoMeetingElement extends HTMLElement {
  ...
  static get observedAttributes() {
    return ['api-key', 'session-id', 'token', 'username', 'is-host', 'meeting-url', 'icons', 'theme', 'landing-page-style', 'pre-join-page-style', 'screenshot-with-chat'];
  }
  connectedCallback() {
    this.render();
  }
  ...
  getProps() {
    var _this$createMeeting, _this$generateToken, _this$extractSessionI;
    return {
      ...
      createMeeting: (_this$createMeeting = this.createMeeting) === null || _this$createMeeting === void 0 ? void 0 : _this$createMeeting.bind(this),
      generateToken: (_this$generateToken = this.generateToken) === null || _this$generateToken === void 0 ? void 0 : _this$generateToken.bind(this),
      extractSessionIdFromUrl: (_this$extractSessionI = this.extractSessionIdFromUrl) === null || _this$extractSessionI === void 0 ? void 0 : _this$extractSessionI.bind(this)
    };
  }
  ...
  async generateToken(sessionId, userData) {
  ...
  render() {
    ...
    this.reactRoot = client.createRoot(container);
    this.reactRoot.render(/*#__PURE__*/React.createElement(VonageVideoMeeting, this.getProps()));
  }
...
export { VonageVideoMeeting, VonageVideoMeetingElement };
